...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zope.component-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12741&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zope.component-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zope.component` can be installed with:

```
conda install zope.component
```

It is possible to list all of the versions of `zope.component` available on your platform with:
